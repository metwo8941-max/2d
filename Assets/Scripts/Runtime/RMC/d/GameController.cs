...
namespace RMC.d.Scenes
{
    ...
    public class GameController : MonoBehaviour
    {
        ...
        protected void Start()
        {
            ...
            // Singleton
            dSingleton.Instance.ThemeManager.IsDark.Subscribe(dSingleton_OnIsDarkChanged).AddTo(_disposable);
        ...
        {
            dSingleton.Instance.ThemeManager.IsDark.Value =
                !dSingleton.Instance.ThemeManager.IsDark.Value;
        }
        ...
        private void dSingleton_OnIsDarkChanged(bool value)
        {
